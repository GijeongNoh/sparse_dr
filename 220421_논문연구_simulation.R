...
ssdr.wrap<-function(X, y, method=c("pc", "sir", "save", "phdres","dr"), d=1, nslices=5, s1.range=NULL, s2.range=NULL, max.iter=200, eps.conv=1e-3)
{
  ...
  # compute criteria for all s1 and s2 (논문의 (10)식 부분)
  crit.all<-list()
...
##  first trial
lambda1 = c(1,0.1)
ssdr.result1 <- ssdr.lambda(x, t(y1), method="dr", d=2, nslices=4, lambda1, lambda2=0.1, max.iter=100, eps.conv=1e-7)
...
for (i in 1:niter){
  ...
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.001, 0.001), lambda2=0.01, max.iter=100, eps.conv=1e-3)
...
beta.true=matrix(0,p,2)
beta.true[1:5,1] = 1; beta.true[6:10,1] = 0.1
beta.true[31:35,2]=0.1; beta.true[36:40,2]=1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y2 = sin(beta.true[,1]%*%t(x))+sin(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
dim(y2)

## first trial
lambda1 = c(0.1,0.1)
ssdr.result2 <- ssdr.lambda(x, t(y2), method="dr", d=2, nslices=10, lambda1, lambda2=0.01, max.iter=100, eps.conv=1e-7)
...
## choose lambda
ssdr.wrap.result2 <- ssdr.wrap(x, t(y2), method="dr", d=2, nslices=10, s1.range=range(0.001, 0.01, 0.05, 0.1, 0.5), s2.range=c(0.001, 0.01, 0.1, 0.5), max.iter=100, eps.conv=1e-7)
ssdr.wrap.result2 # 0.001, 0.1


# simulation 2
beta.true=matrix(0,p,2)
beta.true[1:5,1] = 1; beta.true[6:10,1] = 0.1
beta.true[31:35,2]=0.1; beta.true[36:40,2]=1
beta.true.norm <- apply(beta.true, 2, norm)
p.sdr <- c(); p.dr <- c()
sdr.cor1 <- c(); sdr.cor2 <- c()
dr.cor1 <- c(); dr.cor2 <- c()
...
for (i in 1:niter){
  y = sin(x %*% beta.true[,1])+sin(x%*% beta.true[,2]) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.001, 0.001), lambda2=0.1, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true=matrix(0,p,2)
beta.true[1:10,1] = 1
beta.true[31:40,2]= 1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y3 = sin(beta.true[,1]%*%t(x))+sin(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
dim(y3)
...
## choose lambda
ssdr.wrap.result1 <- ssdr.wrap(x, t(y3), method="dr", d=2, nslices=5, s1.range=range(0.001, 0.01, 0.1, 0.5), s2.range=c(0.01, 0.1, 0.5), max.iter=100, eps.conv=1e-7)
ssdr.wrap.result1 # 0.001, 0.01
...
for (i in 1:niter){
  y = sin(x %*% beta.true[,1])+sin(x%*% beta.true[,2]) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.1, 0.01), lambda2=0.01, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
y2 = beta.true[,1]%*%t(x)/(0.5+(2*beta.true[,2]%*%t(x)+0.3)^2) + sigma*rnorm(n)
dim(y2)
...
set.seed(2022)
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)/(0.5+(2*beta.true[,2]%*%t(x)+0.3)^2) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.1, 0.1), lambda2=0.1, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
  
  # number of p
  p.sdr <- c(p.sdr, 100-ssdr.result1$p.e)
  p.dr <- c(p.dr, sum(dr.beta==0))
...
beta.true=matrix(0,p,2)
beta.true[1:5,1] = 1; beta.true[46:50,2]=1; 
beta.true[6:10,1] = 0.1; beta.true[41:45,2]=0.1; 
beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)
...
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)/(0.5+(2*beta.true[,2]%*%t(x)+0.3)^2) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.05, 0.01), lambda2=0.01, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true=matrix(0,p,2)
beta.true[1:10,1] = 1; beta.true[41:50,2]=1; 
beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)
...
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)/(0.5+(2*beta.true[,2]%*%t(x)+0.3)^2) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.05, 0.01), lambda2=0.01, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)
y1 = beta.true[,1]%*%t(x)*(beta.true[,1]%*%t(x)+beta.true[,2]%*%t(x)+1) + sigma*rnorm(n)
dim(y1)
...
set.seed(2022)
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)*(beta.true[,1]%*%t(x)+beta.true[,2]%*%t(x)+1) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.1, 0.1), lambda2=0.05, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true[7:8,2]=0.1; beta.true[9:10,2]=1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y2 = beta.true[,1]%*%t(x)*(beta.true[,1]%*%t(x)+beta.true[,2]%*%t(x)+1) + sigma*rnorm(n)
dim(y2)
...
beta.true=matrix(0,p,2)
beta.true[1:2,1] = 1; beta.true[3:4,1] = 0.1
beta.true[7:8,2]=0.1; beta.true[9:10,2]=1
beta.true.norm <- apply(beta.true, 2, norm)
p.sdr <- c(); p.dr <- c()
sdr.cor1 <- c(); sdr.cor2 <- c()
dr.cor1 <- c(); dr.cor2 <- c()
...
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)*(beta.true[,1]%*%t(x)+beta.true[,2]%*%t(x)+1) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.05, 0.05), lambda2=0.01, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true=matrix(0,p,2)
beta.true[1:5,1] = 1
beta.true[6:10,2]= 1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y3 = beta.true[,1]%*%t(x)*(beta.true[,1]%*%t(x)+beta.true[,2]%*%t(x)+1) + sigma*rnorm(n)
dim(y3)
...
y1 = beta.true[,1]%*%t(x)/(0.5+(beta.true[,2]%*%t(x)+1.5)^2) + sigma*rnorm(n)
dim(y1)
...
set.seed(2022)
for (i in 1:niter){
  y = beta.true[,1]%*%t(x)/(0.5+(beta.true[,2]%*%t(x)+1.5)^2) + sigma*rnorm(n)
...
beta.true=matrix(0,p,2)
beta.true[1:3,1] = 1; beta.true[4:5,1] = 0.1
beta.true[16:17,2]=0.1; beta.true[18:20,2]=1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y2 = beta.true[,1]%*%t(x)/(0.5+(beta.true[,2]%*%t(x)+1.5)^2) + sigma*rnorm(n)
dim(y2)
...
beta.true=matrix(0,p,2)
beta.true[1:3,1] = 1; beta.true[4:5,1] = 0.1
beta.true[16:17,2]=0.1; beta.true[18:20,2]=1
beta.true.norm <- apply(beta.true, 2, norm)
p.sdr <- c(); p.dr <- c()
sdr.cor1 <- c(); sdr.cor2 <- c()
dr.cor1 <- c(); dr.cor2 <- c()
...
for (i in 1:niter){
  y =beta.true[,1]%*%t(x)/(0.5+(beta.true[,2]%*%t(x)+1.5)^2) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.01, 0.01), lambda2=0.05, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
beta.true=matrix(0,p,2)
beta.true[1:5,1] = 1
beta.true[16:20,2]= 1; beta.true
beta.true.norm <- apply(beta.true, 2, norm)
dim(beta.true)

y3 = beta.true[,1]%*%t(x)/(0.5+(beta.true[,2]%*%t(x)+1.5)^2) + sigma*rnorm(n)
dim(y3)
...
y1 = (beta.true[,1]%*%t(x))^2+0.5*beta.true[,2]%*%t(x) + sigma*rnorm(n)
dim(y1)
...
set.seed(2022)
for (i in 1:niter){
  y = (beta.true[,1]%*%t(x))^2+0.5*beta.true[,2]%*%t(x) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.1, 0.05), lambda2=0.05, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
y2 = (beta.true[,1]%*%t(x))^2+0.5*beta.true[,2]%*%t(x) + sigma*rnorm(n)
dim(y2)
...
for (i in 1:niter){
  y = (beta.true[,1]%*%t(x))^2+0.5*beta.true[,2]%*%t(x) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.05, 0.05), lambda2=0.05, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
y3 = (beta.true[,1]%*%t(x))^2+0.5*beta.true[,2]%*%t(x) + sigma*rnorm(n)
dim(y3)
...
y1 = log(abs(beta.true[,1]%*%t(x)+3))*sign(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
dim(y1)
...
set.seed(2022)
for (i in 1:niter){
  y = log(abs(beta.true[,1]%*%t(x)+3))*sign(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=4, lambda1=c(0.05, 0.05), lambda2=0.05, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=4)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
...
y2 = log(abs(beta.true[,1]%*%t(x)+3))*sign(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
dim(y2)
...
y3 =log(abs(beta.true[,1]%*%t(x)+3))*sign(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
dim(y3)
...
for (i in 1:niter){
  y =log(abs(beta.true[,1]%*%t(x)+3))*sign(beta.true[,2]%*%t(x)) + sigma*rnorm(n)
  ssdr.result1 <- ssdr.lambda(x, y, method="dr", d=2, nslices=10, lambda1=c(0.05, 0.05), lambda2=0.01, max.iter=100, eps.conv=1e-3)
  dr.beta <- beta.order(comp.sdr.dr(x, y, d=2, nslices=10)$beta.sdr)
  beta <- beta.order(ssdr.result1$beta)
