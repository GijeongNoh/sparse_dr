...
## first trial
lambda1 = c(0.1,0.1)
ssdr.result2 <- ssdr.lambda(x, t(y2), method="dr", d=2, nslices=5, lambda1, lambda2=0.01, max.iter=100, eps.conv=1e-7)
...
## choose lambda
ssdr.wrap.result2 <- ssdr.wrap(x, t(y2), method="dr", d=2, nslices=5, s1.range=range(0.001, 0.01, 0.05, 0.1, 0.5), s2.range=c(0.001, 0.01, 0.1, 0.5), max.iter=100, eps.conv=1e-7)
