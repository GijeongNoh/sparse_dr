...
y.tra <- as.numeric(mnist_train[,785]) ; length(y.tra)
y.tes <- as.numeric(mnist_test[,785]); length(y.tes)
...
ssdr.result1 <- ssdr.lambda(x.tra, y.tra, method="dr", d=5, nslices=10, lambda1=c(0.01,0.01,0.01,0.01,0.01), lambda2=0.01, max.iter=100, eps.conv=1e-7)
