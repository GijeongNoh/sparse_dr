...
############################################################
library(RSNNS)
model <- mlp(x.tra.sdr, decodeClassLabels(y.tra), size=c(10,10,10),learnFuncParams=c(0.1), maxit=100)
...
############################################################
library(RSNNS)
model <- mlp(x.tra, decodeClassLabels(y.tra), size=c(300,100,0),learnFuncParams=c(0.1), maxit=100)
